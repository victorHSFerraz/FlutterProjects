// nome dos campos na tabela do banco de dados
import 'dart:async';
...
class Contact {
  ...
  //Construtor que convert os dados de mapa (JSON) para objeto de contato
  ...
  Map toMap() {
    ...
    // O id pode ser nulo caso o registro esteja sendo criado já
    // que é o banco de dados que atribui o id ao registro na hora de salvar
    // Por isso deve testar antes de atribuir
    if (id != null) {
      map[idColumn] = id;
    }
    return map;
